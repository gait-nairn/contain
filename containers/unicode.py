...
class NormalizedStr:
    '''
    Bydefault, Python's str type stores any valid unicode string.
    ...
    *semantically*,
    ...
    def __contains__(self, substr):
        ...
        '''
        norm = unicodedata.normalize(self.normal_form, substr)
        return norm in self.text
